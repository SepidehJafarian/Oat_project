---
title: "sepideh-pc39-oat-time series"
...
require("knitr")
opts_knit$set(root.dir = "C:/Users/SepidehJafarian/Desktop/oat.project/sepideh-oat-rewrite")
library(DESeq2)
library(tximport)
...
wd = "C:/Users/SepidehJafarian/Desktop/oat.project/sepideh-oat-rewrite"
setwd(wd)
getwd()
```
...
```{r, include=TRUE, echo=TRUE}
infile <-  file.path(wd,"input_pc39.modified_no outlier.csv")
...
res_sensitivity<- results(dds, test="Wald", contrast=c("resistance", "sus", "res"))
res_sensitivity
```
